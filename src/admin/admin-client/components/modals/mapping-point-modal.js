    ...
    return (
      <Modal isOpen={ (this.props.activeModalClassName == this.props.className) ? true : false } toggle={this.close} className={this.props.className} size="lg">
        ...
        <ModalBody>
          ...
          <Alert color="info"> 문장해독 점수는 늦게 맞출수록 기본점수에서 2000점 감소된 점수가 지급되고, 5등부터는 같은 점수가 지급됩니다. <br></br> EX) 1등: 10000(기본점수), 2등: 8000, 3등: 6000, 4등: 4000, 5등: 2000, 6등: 2000, 7등: 2000... </Alert>
        </ModalBody>
      </Modal>
    );
  }
